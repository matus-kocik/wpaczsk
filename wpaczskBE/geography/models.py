...
class Country(GeographyBase):
    ...
    )  # Name of the country. // Názov krajiny.
    ...
    )  # ISO code of the country, e.g., 'SK' for Slovakia. // ISO kód krajiny, napr. 'SK' pre Slovensko.
...
class Location(GeographyBase):
    ...
    )  # Reference to the Country model. // Odkaz na model Country.
    ...
    )  # Latitude for the event location. // Zemepisná šírka miesta konania.
    ...
    )  # Longitude for the event location. // Zemepisná dĺžka miesta konania.
