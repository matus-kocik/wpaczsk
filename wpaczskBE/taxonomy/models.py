...
class TaxonomyBase(models.Model):
    ...
    )  # Slovak name of .... // Slovenský názov ... .
    ...
    )  # English name of .... // Anglický názov ... .
...
class TaxonomySubspecies(TaxonomyBase):
    ...
    )  # Average lifespan of the species, subspecies. // Priemerná dĺžka života druhu, poddruhu.
    biotop = models.TextField(
        blank=True,
        null=True,
        verbose_name="Biotop",
        help_text="biotop, ktorý prevažne obýva, ekosystém krajiny, kde sa vyskytuje",
    )  # Biotop of the species, subspecies. // Biotop druhu, poddruhu.
    description = models.TextField(
        blank=True,
        null=True,
        verbose_name="Popis",
        help_text="Popis, detailnejšie a podrobnejšie informácie",
    )  # Description of the species, subspecies. // Popis druhu, poddruhu.
    habitat_countries = models.ManyToManyField(
        Country,
        blank=True,
        verbose_name="Krajiny",
        help_text="Krajiny, kde jedinec žije",
    )  # Countries of the species, subspecies. // Krajiny druhu, poddruhu.
    ...
    )  # Conservation status in nature. // Stav ochrany v prírode.
    ...
    )  # Conservation status in captivity. // Stav ochrany v zajatí.
    ...
    )  # Length of the species, subspecies. // Dĺžka druhu, poddruhu.
    ...
    )  # Weight of the species, subspecies. // Hmotnosť druhu, poddruhu.
