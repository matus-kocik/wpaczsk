...
class Article(ContentBase):
    ...
    )  # Title of the article. // Titulok článku.
    pdf_file = models.FileField(
        upload_to="articles/",
        verbose_name="PDF súbor článku",
        help_text="Nahrajte PDF súbor článku.",
    )  # Link to the article's PDF file. // Odkaz na PDF súbor článku.
    ...
    )  # Main image of article // Titulný obrázok článku
    publication_date = models.DateField(
        verbose_name="Dátum publikácie článku",
        help_text="Zadajte dátum publikácie článku.",
    )  # Date of article publication. // Dátum publikácie článku.
    ...
    )  # Short info of article // Krátke info o článku
...
class Event(ContentBase):
    ...
    )  # Title of the event. // Titulok udalosti.
    pdf_file = models.FileField(
        upload_to="events/",
        blank=True,
        null=True,
    ...
    )  # Link to the event's PDF file. // Odkaz na PDF súbor udalosti.
    main_image = models.ImageField(
    ...
    )  # Short info of event // Krátke info o článku
    ...
    )  # Reference to the Location model. // Odkaz na model.
    # TODO description = models.TextField() ...
    # TODO gallery = models.ManytoManyFields(Image)...
...
class Comment(ContentBase):
    ...
    )  # Title of the comment. // Titulok komentára.
